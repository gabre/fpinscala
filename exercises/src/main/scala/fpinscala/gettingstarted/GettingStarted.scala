...
object TestIsSorted {
  ...
  def main(args: Array[String]): Unit = {
    1 :: List(2)
    println(s"Should be true: ${PolymorphicFunctions.isSorted(Array(), (_: Int) < (_: Int))}")
    println(s"Should be true: ${PolymorphicFunctions.isSorted(Array(0), (_: Int) < (_: Int))}")
    println(s"Should be true: ${PolymorphicFunctions.isSorted(Array(0, 1), (_: Int) < (_: Int))}")
    println(s"Should be true: ${PolymorphicFunctions.isSorted(Array(0, 1, 2), (_: Int) < (_: Int))}")
    println(s"Should be false: ${PolymorphicFunctions.isSorted(Array(3, 1, 5), (_: Int) < (_: Int))}")
  }
}